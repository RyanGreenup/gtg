...
class TaskEditor():
    ...
    def init_dimensions(self):
        ...
        if size and len(size) == 2:
            try:
                ...
                logger.warning('Invalid size configuration for task %s: %s',
        ...
        if position and len(position) == 2:
            try:
                ...
                logger.warning('Invalid position configuration for task %s:%s',
    ...
    def destruction(self, _=None):
        ...
        try:
            ...
            logger.debug('Task %s was already removed from the open list', tid)
